...
2. GRADE. Перш ніж відповідати, оціни кожен знайдений фрагмент: він справді відповідає
   на поставлене питання чи просто лексично схожий? Пошук повертає найближче, а не
   правильне — на питання поза базою він теж щось поверне. Якщо жоден фрагмент не
   відповідає на питання, відповідай прямо: "у базі немає". Не добудовуй відповідь
   із загальних знань про SRE і не переказуй те, що просто згадує ті самі слова.
